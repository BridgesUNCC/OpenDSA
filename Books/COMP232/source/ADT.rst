...
.. raw:: html
   ...
   <script>ODSA.SETTINGS.DISP_MOD_COMP = true;ODSA.SETTINGS.MODULE_NAME = "ADT";ODSA.SETTINGS.MODULE_LONG_NAME = "Abstract Data Types";ODSA.SETTINGS.MODULE_CHAPTER = "Introduction"; ODSA.SETTINGS.BUILD_DATE = "2017-11-27 23:03:57"; ODSA.SETTINGS.BUILD_CMAP = false;JSAV_OPTIONS['lang']='en';JSAV_EXERCISE_OPTIONS['code']='java_generic';</script>
...
.. topic:: Example
   ...
   :ref:`buffer pool  <BuffPool>` rather than directly.
   Variable length records might use a
   :ref:`memory manager  <MemmanIntro>` to find an
