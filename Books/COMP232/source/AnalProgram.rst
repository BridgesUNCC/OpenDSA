...
.. raw:: html
   ...
   <script>ODSA.SETTINGS.DISP_MOD_COMP = true;ODSA.SETTINGS.MODULE_NAME = "AnalProgram";ODSA.SETTINGS.MODULE_LONG_NAME = "Calculating Program Running Time";ODSA.SETTINGS.MODULE_CHAPTER = "Algorithm Analysis"; ODSA.SETTINGS.BUILD_DATE = "2017-11-27 23:03:57"; ODSA.SETTINGS.BUILD_CMAP = false;JSAV_OPTIONS['lang']='en';JSAV_EXERCISE_OPTIONS['code']='java_generic';</script>
...
:term:`amortized analysis  <amortized analysis>` can come to
the rescue.
...
.. avembed:: AV/Searching/binarySearchPRO.html pe
   ...
   :required: True
   :threshold: 1.0
   :exer_opts: JOP-lang=en&amp;JXOP-code=none
