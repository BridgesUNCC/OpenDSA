...
.. raw:: html
   ...
   <script>ODSA.SETTINGS.DISP_MOD_COMP = true;ODSA.SETTINGS.MODULE_NAME = "UnionFind";ODSA.SETTINGS.MODULE_LONG_NAME = "Union/Find";ODSA.SETTINGS.MODULE_CHAPTER = "General Trees"; ODSA.SETTINGS.BUILD_DATE = "2017-11-27 23:03:58"; ODSA.SETTINGS.BUILD_CMAP = false;JSAV_OPTIONS['lang']='en';JSAV_EXERCISE_OPTIONS['code']='java_generic';</script>
...
Recall that an
:ref:`equivalence relation  <SetDef>` is
...
:term:`amortized analysis  <amortized analysis>`.
