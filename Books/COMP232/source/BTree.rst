...
.. raw:: html
   ...
   <script>ODSA.SETTINGS.DISP_MOD_COMP = true;ODSA.SETTINGS.MODULE_NAME = "BTree";ODSA.SETTINGS.MODULE_LONG_NAME = "B-Trees";ODSA.SETTINGS.MODULE_CHAPTER = "Indexing"; ODSA.SETTINGS.BUILD_DATE = "2017-11-27 23:03:58"; ODSA.SETTINGS.BUILD_CMAP = false;JSAV_OPTIONS['lang']='en';JSAV_EXERCISE_OPTIONS['code']='java_generic';</script>
...
managed using a :ref:`buffer pool  <BuffPool>`
...
.. avembed:: AV/Indexing/bPlusTreeInsertPRO.html pe
   ...
   :required: True
   :threshold: 0.9
   :exer_opts: JOP-lang=en&amp;JXOP-feedback=continuous&amp;JXOP-code=java_generic
...
A :term:`K-ary tree  <K-ary tree>` has
